...
Modu≥ dla PHP dodaj±cy obs≥ugÍ dla baz danych FreeTDS za po∂rednictwem
interfejsu PDO.
...
Modu≥ dla PHP dodaj±cy obs≥ugÍ dla baz danych MySQL za po∂rednictwem
interfejsu PDO.
...
Modu≥ dla PHP dodaj±cy obs≥ugÍ dla baz danych ODBC za po∂rednictwem
interfejsu PDO.
...
Modu≥ dla PHP dodaj±cy obs≥ugÍ dla baz danych PostgreSQL za
...
Modu≥ dla PHP dodaj±cy obs≥ugÍ dla baz danych SQLite za po∂rednictwem
interfejsu PDO.
